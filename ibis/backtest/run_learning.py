#!/usr/bin/env python3
"""Run a synthetic backtest and produce learning suggestions."""
...
async def main():
    ...
    candles = {s: CandleGenerator.generate_candles(s, days=60, volatility=0.03) for s in symbols}
    ...
    out_path = data_dir / "learning_suggestions.json"
