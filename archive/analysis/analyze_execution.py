...
async def analyze_execution():
    ...
    risk_metrics = agent.get_risk_metrics()
    print("🛡️ RISK MANAGEMENT:")
    print(f"   Total capital: ${risk_metrics.get('total_capital', 0):.2f}")
    print(f"   Risk per trade: {risk_metrics.get('risk_per_trade', 0):.1%}")
    print(f"   Max positions: {risk_metrics.get('max_positions', 0)}")
